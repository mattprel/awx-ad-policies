...
# This file incorporates code from joshinryz/ansible_ldap_inventorye, https://github.com/joshinryz/ansible_ldap_inventory.
# The original code is Copyright (©) the original author(s) and licensed under
# the GNU General Public License v3.0 (see LICENSE for details).

# Modifications © 2025 Matthias Prel-Everex
# Licensed under the GNU General Public License v3.0.

# Thank you @joshinryz (on GitHub), and all other contributors to the original project!

# THIS PROJECT IS LICENCED UNDER GPLv3.0
# ANY MODIFICATIONS MADE TO IT MUST BE EXPLICITLY DOCUMENTED
# TO SATISFY THIS REQUIREMENT, ANY MODIFICATIONS MADE TO THIS FILE HAVE BEEN DOCUMENTED BELOW AND IN THE README FILE AT THE ROOT OF THIS PROJECT.
...
#
# Line changed to: ouGroups = self._detect_group(item[0])
#                  if not ouGroups:
